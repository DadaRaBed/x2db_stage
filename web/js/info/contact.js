...
function showContactModal() {
  ...
  overlay.innerHTML = `
    <div style="background: var(--card-bg, #ffffff); color: var(--text-color, #1a1a2e); border-radius: 12px; padding: 0; max-width: 560px; width: 95%; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.4); overflow: hidden;">
      ...
      <div style="padding: 24px;">
        <p style="color: var(--text-muted, #64748b); font-size: 0.9rem; margin-bottom: 1.5rem;">
          Envoyez un email au developpeur (DadaRaBed). Nous vous repondrons dans les plus brefs delais.
        </p>
        <div class="form-group" style="margin-bottom: 1rem;">
          <label style="display: block; font-weight: 600; margin-bottom: 6px; color: var(--text-color, #334155); font-size: 0.9rem;">Votre email (optionnel) :</label>
          <input type="email" id="contact-email" placeholder="votre.email@example.com"
        ...
        <div class="form-group" style="margin-bottom: 1rem;">
          <label style="display: block; font-weight: 600; margin-bottom: 6px; color: var(--text-color, #334155); font-size: 0.9rem;">Sujet :</label>
          <input type="text" id="contact-subject" placeholder="Sujet de votre message" value="[xl2db] Demande de contact"
            style="width: 100%; padding: 0.6rem; border: 1px solid var(--border-color, #cbd5e1); border-radius: 6px; font-size: 0.9rem; box-sizing: border-box; background: var(--bg-input, #ffffff); color: var(--text-color, #1a1a2e);" />
        </div>
        <div class="form-group" style="margin-bottom: 1rem;">
          <label style="display: block; font-weight: 600; margin-bottom: 6px; color: var(--text-color, #334155); font-size: 0.9rem;">Message :</label>
          <textarea id="contact-message" rows="6" placeholder="Decrivez votre demande, question ou suggestion..."
            style="width: 100%; padding: 0.6rem; border: 1px solid var(--border-color, #cbd5e1); border-radius: 6px; font-size: 0.9rem; box-sizing: border-box; font-family: inherit; resize: vertical; background: var(--bg-input, #ffffff); color: var(--text-color, #1a1a2e);"></textarea>
        </div>
